        ...
        <div className="py-20 px-6 md:px-20 lg:px-32 grid place-items-center">
            ...
            <div className="max-w-[600px] mx-auto">
                ...
                <div className="mt-6 flex items-center justify-center gap-2">
                    <Button variant="secondary" asChild><Link className="flex items-center justify-center gap-2" href="https://github.com/MeAkash77/Zen-Pay">Source<Github className="h-4 w-4 hidden" /></Link></Button>
